...
class ElementSquareGUI(SquareGUI):
    ...
    def setup(self):
        if self.orient == "H":
            ...
            self.canv.create_text(
                (70, 58), text=f"{round(float(self.square.AtomicNumber))}", fill="#555555", anchor=CENTER, font=Font(12),
            )
        else:
            ...
            self.canv.create_text(
                (58, 70), text=f"{round(float(self.square.AtomicNumber))}", fill="#555555", anchor=CENTER, font=Font(12),
                angle=angle
            )
